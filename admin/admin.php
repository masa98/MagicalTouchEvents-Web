...
// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- add to database
        $query = "SELECT * FROM events.admin where password='".$p."' and username='".$u."' ";
        ...
        if($num_results<1 ){
            ...
            header("location:../loginadmin/login/login.php");
        }
        $db->close();
    }
}
...
// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- add to database
                                ...
                                $num_results = $result->num_rows;
                                if($num_results==1 ){
                                    echo "<a class=\"btn gradient-bg\" href=\"#\">$row[0]</a>";
                                }

                                else{
                                    echo " <a class=\"btn gradient-bg\" href=\"#\">Admin</a>";
