            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-3 d-none d-lg-block order-2 order-lg-3">
                    <div class="buy-tickets">
                        <a class="btn gradient-bg" href="index.html">Log out</a>
                    </div><!-- .buy-tickets -->
                </div><!-- .col -->
            </div><!-- .row -->
        </div><!-- .container-fluid -->
            ...
            <div class="row profile"> <?php
                ...
                if ($conn->connect_error) {
                    die("Connection failed: " . $conn->connect_error);
                            ...
                            //$email=$_POST[Email];
                            $disp=mysqli_query($conn,"select * from users where email='masa.sam.98@hotmail.com'");//edittttttttt

                while ($result = mysqli_fetch_array($disp,MYSQLI_ASSOC)) {
                ?>
                <img src="images/<?php echo $result['pic'];?>" style="width: 17%;height: 17%; border-radius: 50%;">
                    ...
                    <div class="contact-location-details" >
                        <footer class="entry-footer" style="margin-left: 0">
                            <ul>
                                    ...
                                    <li style="color: white;background: url(images/icons8-email-sign-24.png)no-repeat left center;" class="contact-email"><?php echo $result['email'];?></li>
                                    <li style="color: white" class="contact-number"><?php echo $result['phone'];?></li>
                                <?php
                                }
                                ?>
                                <form action="change.php" enctype="multipart/form-data">
                                    <p style="color: white">change your picture:
                                 <input style="width:90%; height: 35%" id="image" type="file" name="profile_photo" placeholder="Photo" required="" capture></p>
                                <input style="background-color: #9a28d7;border-radius: 20%;border-color: #581687" type="submit" value="Submit" name="submit" src=""></p>
                                </form>
...
$disp=mysqli_query($conn,"select * from event where email='masa.sam.98@gmail.com'");//edittttttttt
            ...
            <div class="event-content-wrap">
                <header class="entry-header flex flex-wrap justify-content-between align-items-end">
                    ...
                    <div class="buy-tickets flex justify-content-center align-items-center">
                        <a class="btn gradient-bg" href="Booking/book.html">Book New One</a>
                    </div>
                </header>
            </div>
        </div>
                ...
                <div class="tabs-container">
                    ...
                    <div id="tab_venue" class="tab-content">
                        ...
                        <p>Please give us your notice:</p>
                            ...
                            <a class="btn gradient-bg" href="" style="margin-top: 1em" onclick=function feed() {
                               <?php
                               $fd=
                               $result = "UPDATE `event` SET `feedback`='$target' WHERE email='masa.sam.98@hotmail.com'"
                               ?>
                               }>Submit</a>
                    </div>
